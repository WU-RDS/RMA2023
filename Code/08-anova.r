...
# https://imsmwu.github.io/MRDA2019/_book/hypothesis-testing.html#comparing-several-means
...
# Alternatively, using the ggstatsplot package
## ------------------------------------------------------------------------
library(ggstatsplot)
ggbetweenstats(
  data = hours_abc,
...
#save plot (optional)
## ------------------------------------------------------------------------
ggsave("anova.jpg", height = 5, width = 7.5)
