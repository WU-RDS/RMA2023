...
# https://imsmwu.github.io/MRDA2018/_book/introduction-to-statistical-inference.html

#-------------------------------------------------------------------#
#---------------------Install missing packages----------------------#
#-------------------------------------------------------------------#

req_pacakges <- c("ggplot2","psych")
...
## ------------------------------------------------------------------------
music_listening_population <- read.table("https://raw.githubusercontent.com/IMSMWU/MRDA2018/master/data/hours_population_normal.csv", 
                        sep = ";", 
                        header = TRUE)
head(music_listening_population)
# Compute descriptives for population
psych::describe(music_listening_population)
# Create histogram
library(ggplot2)
