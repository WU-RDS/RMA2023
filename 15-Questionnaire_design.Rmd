...
1. **Questionnaire design & data collection**: In the first part, you will work with your group on creating a questionnaire. Once you have created a draft of your questionnaire, you will receive a feedback from us. After implementing the feedback, you will be ready to collect your data using an online survey. 
2. **Data analysis & presentation**: In the second part, you will apply the statistical knowledge acquired during the course. You will analyze the collected data, present your findings using an video recording and finally submit your final report (R code and presentation).
...
In this section, you can find some guidelines that might be useful to know when designing your questionnaire and the final presentation.
...
For the presentation of your questionnaire design, you should consider the following points:
...
* Although we won't have covered all methods when you submit your questionnaire design, you should plan ahead and present some ideas in the questionnaire design part on how you plan to analyze your data
