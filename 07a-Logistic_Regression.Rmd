...
We are now going to show how to perform logistic regression in R. We are going to analyse the probability that somebody cheats on their spouse. As explanatory variables sex, age, religiousness (1 = anti, 5 = very), self rating of marriage (1 = very unhappy, 5 = very happy) and years married are used. 
