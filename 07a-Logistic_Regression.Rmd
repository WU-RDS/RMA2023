...
library(knitr)
options(digits = 3)
opts_chunk$set(tidy.opts=list(width.cutoff=50), tidy=TRUE, rownames.print = FALSE, rows.print = 10, message = FALSE, warning = FALSE, echo = TRUE)
```
