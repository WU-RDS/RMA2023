...
$$
\frac{1}{\sqrt{2 \pi σ^2}} \int_{-∞}^x e^{\frac{-(t-μ)^2}{2 σ^2}} dt
$$

<iframe src="http://localhost:3838/learnNormaldens/normalCommands/" style="border: none; width: 900px; height: 650px"></iframe>
