...
Once you have sufficient clarity on your research hypothesis, you should specify the **research design**. One of the most important aspects you need to reflect on when choosing an appropriate research design is the nature of the research objective. That is, whether the objective you would like to achieve with your research can be classified as *descriptive*, *predictive*, or *prescriptive*. The following table shows examples of research questions that fall in each of these categories.
...
Although it appears from the graphic that there is an association between the Internet Explorer market share and the number of murders in the U.S., it wouldn't really make sense to assume that one of them *causes* the other. For a causal relationship, three conditions have to be met (Field et al. 2012): 
...
> "Underlying this is the recognition, description, and presentation of the identication strategy, 
> or the manner in which a researcher uses observational data (i.e., data not generated by a randomized trial) 
> to approximate a real experiment"
>
...
```{r,echo=FALSE,out.width = '70%',fig.align='center',fig.cap = "Flow chart for test selection"}
...
For survey-based research, there are many different scale types to choose from. Below you can find a summary of some of the most common scaling techniques. For details regaring these scaling techniques, please refer to chapter 10, which dedicated to the topic of questionnaire design.   
...
- [ ] The reliability of the scale can be measures using Cronbach’s Alpha.
- [ ] The indicators (items) of the scale should be highly correlated.
- [ ] The validity of the scale can be measures using Cronbach’s Alpha.
- [ ] None of the above
