...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=TRUE}
#spotify_data <- read.csv("/home/felix/Documents/e-Assistant IMSM/course_daniel/music_data.csv", 
#                          sep = ",", 
#                          header = TRUE) #read in data
#spotify_data <- na.omit(spotify_data[,c(16:26)])
```
...
fast <- music_data[,c(rc2)]
pitch <- music_data[,c(rc3)]
dancefloor <- music_data[,c(rc4)]
```
