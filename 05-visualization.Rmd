...
ggplot(data = music_data) + 
  geom_count(aes(x = genre_cat, y = popularity_factor))  + 
  ylab("Popularity") + 
  xlab("Genre") + 
  theme_bw()
```
...
table_plot_abs <- as.data.frame(table(music_data[,c("genre_cat", "popularity_factor")])) #absolute frequencies

ggplot(table_plot_abs, aes(x = genre_cat, y = popularity_factor)) + 
