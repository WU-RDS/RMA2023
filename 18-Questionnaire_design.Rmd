...
```{r}
ml.dinner <- lm(dinner$` Willingness-to-pay (in EUR)` ~ dinner$` Location` + dinner$` Price` + dinner$` Ambience`+dinner$` Customer Service`) #estimate linear model
summary(ml.dinner) #summary of results
```
