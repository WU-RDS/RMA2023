...
# Prepared data for visualisation
kable(mlc_visualisation,align = "c")
...
```{r, echo=FALSE}
knitr::kable(head(qualtrics$` Willingness-to-pay (in EUR)`))
```
...
```{r}
# Outliers
mlr.dinner$stud_resid <- rstudent(mlr.dinner)
head(mlr.dinner)
```
