...
There will be 3 individual assignments and most assignments are complemented with a coaching session. Note that the assignments need to be submitted in the [R Markdown format](https://rmarkdown.rstudio.com/) (see chapter 10) via Learn\@wu. There will be a coaching sessions dedicated to the R Markdown reporting format after the second assignment has been assigned. 
