...
There will be 3 individual assignments and each assignment is complemented with a coaching session. Note that the assignments need to be submitted in the [R Markdown format](https://rmarkdown.rstudio.com/) (see chapter 10) and there will be a coaching sessions dedicated to this reporting format. The submission dates and the dates and times for the coaching sessions are summarized in the following table: 
...
mytable_sub_1 = data.frame(
    ...
    Coaching = c("* no coaching", 
             "* Oct. 27, 08:00AM-11:00AM (compulsory) <br>Nov. 10, 04:00PM-07:00PM* <br>Nov. 12, 04:00PM-08:00PM*",
             "* Nov. 23, 04:00PM-07:00PM* <br>Nov. 26, 04:00PM-08:00PM*"
             ),
    Submission = c(
      "Oct. 24, 11:59PM",
      "Nov. 14, 11:59PM",
...
mytable_sub_1 = data.frame(
    ...
    Coaching = c("* no coaching", 
             "* Oct. 29, 08:00AM-11:00PM (compulsory) <br>Nov. 12, 04:00PM-08:00PM* <br>Nov. 15, 04:00PM-07:00PM*",
             "* Nov. 22, 04:00PM-07:00PM* <br>Nov. 26, 04:00PM-08:00PM*"
             ),
    Submission = c(
      "Oct. 26, 11:59PM",
      "Nov. 16, 11:59PM",
...
Please make sure that you have exhausted all other sources of help, such as the online tutorial, the forum on Learn\@wu and web-searches before you schedule a coaching session. Since students tend to have similar questions, the goal should be to make the responses available to other students in the course (e.g., by posting in the forum).
