...
The marketing research group project consists of multiple consecutive steps: the design of a questionnaire, data collection using an online survey, data handling, data analysis, and presentation of the results. We will offer coaching sessions via live video streaming throughout the process, providing feedback and allowing you to ask questions. The submission dates and the dates and times for the coaching sessions are summarized in the following table: 
...
The main reference for this course is this website and the required readings are indicated in the table above. At the end of each chapter, you will find a section with references. In case you would like to obtain additional information on a topic, you may consult these references for further clarification.  
