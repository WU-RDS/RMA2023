...
Given our sample size and the variability in our data, we are 95% confident that the true level of overall statistical knowledge is between `r round(ci_lower,0)` and `r round(ci_upper,0)`!

Note that the CI is also implicitly included in the summary statistics created by the ```stat.desc()``` function.  
