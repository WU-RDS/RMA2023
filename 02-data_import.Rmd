...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=FALSE, fig.align="center", fig.height = 3, fig.width = 8, fig.cap="Data import"}
library(EBImage)
img = readImage("https://github.com/IMSMWU/Teaching/raw/master/MRDA2017/Graphics/data_import.JPG")
...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=FALSE, fig.align="center", fig.height = 2.5, fig.width = 8, fig.cap="Obtaining data from APIs"}
library(EBImage)
img = readImage("https://github.com/IMSMWU/Teaching/raw/master/MRDA2017/API.JPG")
display(img, method = "raster")
```
...
```{r message=FALSE, warning=FALSE}
library(gtrendsR)
google_trends <- gtrends("data science", geo = c("US"), gprop = c("web"), time = "2017-09-01 2017-10-06")
ls(google_trends)
