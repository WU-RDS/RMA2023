...
```{r message=FALSE, warning=FALSE, eval=TRUE, echo=FALSE, fig.align="center", fig.height = 6, fig.cap="The R anxiety questionnaire (source: Field, A. et al. (2012): Discovering Statistics Using R, p. 768)"}
library(EBImage)
