...
```
This difference occurs because non-parametric tests have more power to detect differences between groups since we lose information by ranking the data. Thus, you should rely on parametric tests if the assumptions are met.
...
- [ ] When the test-statistic (e.g., t-value) exceeds the critical value of the test statistic at your specified significance level (e.g., 0.05)
...
- [ ] To compare the means for two or more populations
...
- [ ] Tests for association between two or more categorical variables
- [ ] None of the above 
